...
import 'modified_td_dialog_widget.dart';
...
/// 支持横向或竖向摆放按钮
/// 横向最多摆放两个按钮
class ModifiedTDAlertDialog extends StatelessWidget {
  /// 横向按钮排列的对话框
  ///
  /// [leftBtn]和[rightBtn]不传style参数会应用默认样式，左侧弱按钮，右侧强按钮
  const ModifiedTDAlertDialog({
    Key? key,
  ...
  const ModifiedTDAlertDialog.vertical({
    Key? key,
